...
const Index = () => {
  ...
  const handleContactClick = () => {
    toast({
      title: "Let's connect!",
      description:
        "Email client opened! Feel free to also reach me on LinkedIn.",
    });
  };
          ...
          <div className="container mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto mb-8">
                Full Stack Developer & Cybersecurity Enthusiast Building web
                applications, networking tools, and security-focused software
                with React, Node.js, and Python.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a
                  href="https://mail.google.com/mail/?view=cm&to=alexuduma50@gmail.com&su=Job%20Offer&body=Hello%20buddy,%20I%20saw%20your%20portfolio%20and%20i%20am%20impressed"
                  target="_blank"
                ...
                <a href="/Alex-Uche-Resume.pdf" download="Alex-Uche-Resume.pdf">
              ...
              <div className="flex justify-center space-x-6 mt-8">
                <a
                  href="https://github.com/Jaguar-Uche"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://www.linkedin.com/in/alex-uche/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-muted-foreground hover:text-primary transition-colors"
                >
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <p className="text-muted-foreground leading-relaxed mb-6">
                    I'm a full-stack developer who enjoys building things from
                    scratch and figuring out how systems work under the hood. My
                    interests range from web development and backend engineering
                    to networking and cybersecurity. When I'm not coding, you'll
                    probably find me playing chess, learning something new, or
