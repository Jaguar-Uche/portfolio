export const skills = [
  ...
  export const projects = [
    {
      ...
      description: "A web-based network scanning tool built with Python, sockets, and multithreading. Safely audits the first 100 ports of scanme.nmap.org and presents discovered services and potential vulnerabilities through an intuitive dashboard.",
    ...
    {
      title: "Messaging App",
      description: "A real-time messaging platform built with Socket.IO, allowing users to exchange messages instantly, share images, and communicate seamlessly across different locations through a modern chat interface.",
      image: "/chatapp.jpg",
    ...
    },
    {
      ...
      description: "A modern AI chat interface powered by OpenAI's GPT models. Users can send messages and images, receive AI-generated responses, and enjoy a clean, responsive user experience with secure authentication.",
      image: "/robott.jpg", 
    ...
    {
      title: "Book Store",
      description:"A full-stack bookstore management application that allows users to create, view, edit, and delete book records. Includes detailed book information such as title, author, and description, with support for both table and card-based views.",
      image: "/book_site.jpg",
    ...
    {
      title: "Online Store",
      description: "A community-driven marketplace application where users can create, view, update, and delete product listings. Features image uploads, pricing information, and a responsive interface for managing items.",
    ...
    {
      title: "Movie List",
      description: "A movie discovery application that integrates with The Movie Database API to display trending films, search for specific titles, and save favorite movies for quick access later.",
  ...
  export const games = [
    {
      title: "Snake Game",
      description: "Help the Snake reach its food. Use the arrow keys for direction. Watch the magic when the snake feeds",
    ...
    {
      title: "Ping Pong",
      description: "Play ping pong with your friend or your left hand. Arrow keys for you and W and S for your friend or other hand😭😭😭",
      image: "/ping_pong.jpg",
      technologies: ["Html", "JavaScript", "CSS", "CanvasAPI"],
